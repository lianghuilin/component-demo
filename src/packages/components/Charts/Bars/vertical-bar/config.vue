      ...
      <el-collapse v-model="activeCollapseName">
        ...
        <el-collapse-item title="图例" name="legend">
          ...
          <el-collapse>
            ...
            <el-collapse-item title="图裂样式" name="style">
              <el-form-item label="类型">
                <el-select v-model="legend.icon" size="small" class="el_select_wrapper">
                  <el-option
                    v-for="(item, index) in barConf.barStyle.legendTypesList"
                    :key="index"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
            ...
            >
              <el-form label-width="85px" label-position="left" class="series-content">
                ...
                <el-form-item label="是否堆叠">
                  <el-select v-model="item.stack" size="small" class="el_select_wrapper">
                    <el-option
...
import { seriesBarData } from "./config.ts";
...
const addSeries = () => {
  ...
  seriesList.value.push(cloneDeep(seriesBarData));
...
const deleteSeries = () => {
  ...
  nextTick(() => {
    ...
    if (props.optionData.legend.data) props.optionData.legend.data.pop();
